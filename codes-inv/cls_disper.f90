...
contains
  ...
  double precision function disper_get_hv(self, i) result(hv)
    class(disper), intent(in) :: self
    integer, intent(in) :: i
    ...
    return 
  end function disper_get_hv

  !---------------------------------------------------------------------

  function disper_get_hv_array(self) result(hv)
    class(disper), intent(in) :: self
    double precision :: hv(self%nx)
